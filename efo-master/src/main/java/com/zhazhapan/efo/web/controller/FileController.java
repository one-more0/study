...
//        User user = (User) request.getSession().getAttribute(ValueConsts.USER_STRING);
        return Formatter.listToJson(fileService.listUserDownloaded( offset, search));
    }
...
//        User user = (User) request.getSession().getAttribute(ValueConsts.USER_STRING);
        return Formatter.listToJson(fileService.listUserUploaded( offset, search));
    }
...
//        User user = (User) request.getSession().getAttribute(ValueConsts.USER_STRING);
        ...
        } else if (fileService.removeFile( id)) {
