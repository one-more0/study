...
function scan(visitUrl){
    var url = 'http://localhost:8089'+visitUrl; //要预览文件的访问地址
    ...
    if (resources.length < 1) {
        ...
        $.each(resources, function (i, resource) {
            ...
            contentHtml += "<div class='row content-box rounded' data-id='" + resource.id + "'><div class='col-12 col-sm-12'><br/><div class='row'>" +
                ...
                ("#uploaded-content" === tabId ? "&emsp;<a href='javascript:;' class='font-1' onclick='editFile();'>编辑</a>&emsp;<a href='javascript:;' class='font-1' onclick='removeFile();'>删除</a>&emsp;<a style='color: #9c27b0' onclick='scan(\""+resource.visitUrl+"\")'>在线预览</a>" : "") +
